...
ADC_Ellipsoid = trisurf(C_sph,SIG_alldir(:,1),SIG_alldir(:,2),SIG_alldir(:,3),SIG_interp,'facealpha',0.8); 

view(3); caxis([0,1]); colorbar; 
axis equal;
...
plot3(SIG_allcmpts_alldir.*points(:,1),SIG_allcmpts_alldir.*points(:,2),...
    SIG_allcmpts_alldir.*points(:,3),'k.','markersize',15);