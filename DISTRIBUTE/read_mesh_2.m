function [mymesh] = read_mesh_2(fname, sigma0)
...
mymodel1 = createpde();
mymodel2 = createpde();
elements1 = load([fname, '_1_elements.txt']);
nodes1 = load([fname, '_1_nodes.txt']);
elements2 = load([fname, '_2_elements.txt']);
nodes2 = load([fname, '_2_nodes.txt']);
