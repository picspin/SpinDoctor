...
fname_params_cells = 'params_cells_spindle_dendrites_signal_2.in';
fname_params_simul_domain  = 'params_simul_domain.in';
fname_params_simul_experi = 'params_simul_experi_spindle_dendrites_signal_2.in';
...
if (~isempty(mymesh))
    ...
    if (experi_common.ngdir_total == 1)
        ...
        if (~isempty(experi_btpde))
            ...
            % save('dendrites_signal_2.mat')
            
            % load('dendrites_signal_2.mat')
