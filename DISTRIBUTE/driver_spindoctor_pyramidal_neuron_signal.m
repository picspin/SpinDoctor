...
fname_params_cells = 'params_cells_pyramidal_neuron_signal.in';
...
if (~isempty(mymesh))
    ...
    if (experi_common.ngdir_total == 1)
        ...
        if (~isempty(experi_btpde))
            ...
            save('pyramidal_neuron_signal_d10_D43_3bvalues_180gdir_0')
            ...
            save('pyramidal_neuron_signal_d10_D43_3bvalues_180gdir')
        end
        %HADC
        if (~isempty(experi_hadc))
